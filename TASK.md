# Техническое задание на позицию Senior Backend-разработчика
...
- Docker и Docker Compose (развертывание сервиса при параллельной отправке).
...
3. Соответствие всем указанным тербованиям.

### Критерии оценки

1. Архитектурная проработанность:

   - Разделение логики на слои (контроеллры, сервисы, репозитории)
...
4. Соответствие заданиям:
   ...
   - Предотавращение дублирования сообщений при параллельной отправке

### Дополнительное задание (по желанию, но как плюс к кандидату)

- Реализовать меахнизм подключения к нескольким устройствам одновременно (как в Telegram Web).
